...
const MindMap = () => {
  ...
  // Update the conversion function to properly format data for MindElixir
  const convertToMindElixirFormat = (node: MindMapNode): NodeData => {
    return {
      ...
      expanded: true,
      // Store additional data in a custom field
      data: {
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          {mindMapData && (
            <button
              ...
              className="ml-auto flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-indigo-500 to-purple-500 text-white rounded-lg hover:opacity-90 transition-all transform hover:scale-105"
            >
              {viewMode === "2d" ? <Maximize size={16} /> : <Minimize size={16} />}
              <span>{viewMode === "2d" ? "Visualização 3D" : "Visualização 2D"}</span>
            </button>
          )}
        </div>
                ...
                <div>
                  <div className="flex justify-between items-center mb-6">
                    ...
                    <div className="flex gap-2">
                      ...
                      <button 
                        className="p-2 bg-green-100 text-green-600 rounded-lg hover:bg-green-200 transition-colors transform hover:scale-105"
                        title="Compartilhar"
                      >
                        <Share size={20} />
                      </button>
                    ...
                    <div>
                      <div className="flex gap-2 mt-4 mb-2">
                        <button 
                          onClick={() => {
                            if (mindElixirInstanceRef.current) {
                              mindElixirInstanceRef.current.enterFocusMode();
                            }
                          }}
                          className="p-2 bg-blue-100 text-blue-600 rounded-lg hover:bg-blue-200 transition-colors transform hover:scale-105"
                          title="Modo de foco"
                        ...
                        <button 
                          onClick={() => {
                            if (mindElixirInstanceRef.current) {
                              mindElixirInstanceRef.current.quit();
                            }
                          }}
                          className="p-2 bg-blue-100 text-blue-600 rounded-lg hover:bg-blue-200 transition-colors transform hover:scale-105"
                          title="Cancelar foco"
                        ...
                        <button 
                          onClick={() => {
                            if (mindElixirInstanceRef.current) {
                              mindElixirInstanceRef.current.zoomIn();
                            }
                          }}
                          className="p-2 bg-blue-100 text-blue-600 rounded-lg hover:bg-blue-200 transition-colors transform hover:scale-105"
                          title="Ampliar"
                        ...
                        <button 
                          onClick={() => {
                            if (mindElixirInstanceRef.current) {
                              mindElixirInstanceRef.current.zoomOut();
                            }
                          }}
                          className="p-2 bg-blue-100 text-blue-600 rounded-lg hover:bg-blue-200 transition-colors transform hover:scale-105"
                          title="Reduzir"
